#!/usr/bin/env python3
"""INVICTUS 모닝 브리핑 v5 — 전 지표 신호등 + 모멘텀 순위.

패치 이력:
    - 2026-04-21 v5.0: 뉴스 기능 완전 제거 (Commander 결정).
                      한경·외신 RSS 수집, Claude 번역·요약·rich 카드 모두 제거.
                      ANTHROPIC_API_KEY·xml.etree.ElementTree·re 의존 제거.
                      코어 INVICTUS 브리핑(e1~e7)만 유지. Claude API 과금 0.
...
# ANTHROPIC_API_KEY: v5.0에서 제거 (뉴스 기능 삭제로 Claude 호출 없음)
