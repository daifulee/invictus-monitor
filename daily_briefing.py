...
import os,requests,json,xml.etree.ElementTree as ET,math
...
#   2) URL의 마지막 부분이 slug → 아래 값만 교체
#   3) dir: "YES"=가격↑이면 시나리오 강화 / "NO"=가격↑이면 시나리오 약화
#   4) w: 같은 시나리오 내 상대 가중치 (합 1.0 권장)
# 주의: 마켓이 해결/만료되면 주기적 교체 필요 (월 1회 점검 권장)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SCENARIO_MAP = {
    "S1": {"label":"🕊️ 급속해결","method":"weighted","markets":[
        {"slug":"will-iran-reopen-strait-of-hormuz-by-june-30-2026","dir":"YES","w":0.40},
        {"slug":"oil-below-80-by-end-of-2026","dir":"YES","w":0.30},
        {"slug":"will-us-iran-sign-ceasefire-deal-by-q3-2026","dir":"YES","w":0.30},
    ]},
    "S2": {"label":"⚖️ 통제된긴장","method":"complement","markets":[]},  # 1-(S1+S3+S4)
    "S3": {"label":"🔥 스태그플레이션","method":"weighted","markets":[
        {"slug":"us-recession-in-2026","dir":"YES","w":0.30},
        {"slug":"will-us-cpi-exceed-4-in-2026","dir":"YES","w":0.30},
        {"slug":"will-fed-cut-rates-before-september-2026","dir":"NO","w":0.25},  # 인하지연=스태그 강화
        {"slug":"oil-above-100-by-end-of-2026","dir":"YES","w":0.15},
    ]},
    "S4": {"label":"💀 복합위기","method":"weighted","markets":[
        {"slug":"will-vix-exceed-40-in-2026","dir":"YES","w":0.30},
        {"slug":"will-us-iran-direct-military-conflict-escalate-2026","dir":"YES","w":0.30},
        {"slug":"will-sp500-drop-20-percent-in-2026","dir":"YES","w":0.25},
        {"slug":"china-invade-taiwan-by-2027","dir":"YES","w":0.15},
    ]},
}
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def build_oracle_embed(probs,raw_markets,status):
    ...
    return{"title":"🔭 Oracle §3.5 │ Polymarket 시나리오 확률","color":0x9B59B6,"description":desc}
...
def build(d,reg,grd,trg,oracle):
    ...
    e1={"title":f"🛡️ INVICTUS 모닝 리포트 ☕ — {date}","color":sc,"description":(
    ...
    e5={"title":"📊 Legio 모멘텀 Top10 (20종목 중)","color":0x3DBB7E,"description":(
        "\n".join(lines)
    )}

    # 6️⃣ SPY + 트리거 + 재진입 + 진입게이트
    eg=d["EG"]
    e6={"title":"📈 SPY │ 트리거 │ 재진입 │ 진입게이트","color":0x3DBB7E,"description":(
...
def main():
    ...
    send({"content":f"🛡️ **INVICTUS 모닝 리포트** ☕\n{now.strftime('%Y-%m-%d %H:%M KST')}","embeds":embeds[:5]})
